<nav class="navbar">
    <div class="navbar-content">
        ...
        <div class="logo-mini-wrapper">
            <img src="https://nobleui.com/laravel/template/demo1/build/images/logo-mini-light.png"
                class="logo-mini logo-mini-light" alt="logo">
            <img src="https://nobleui.com/laravel/template/demo1/build/images/logo-mini-dark.png"
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex" href="#" id="languageDropdown" role="button"
                    ...
                    <img src="https://nobleui.com/laravel/template/demo1/build/images/flags/us.svg" class="w-20px"
                        title="us" alt="flag">
                    <span class="ms-2 d-none d-md-inline-block">English</span>
                </a>
                <div class="dropdown-menu" aria-labelledby="languageDropdown">
                    <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            src="https://nobleui.com/laravel/template/demo1/build/images/flags/us.svg" class="w-20px"
                            title="us" alt="us"> <span class="ms-2"> English
                        </span></a>
                    <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            src="https://nobleui.com/laravel/template/demo1/build/images/flags/fr.svg" class="w-20px"
                            title="fr" alt="fr"> <span class="ms-2"> French
                        </span></a>
                    <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            src="https://nobleui.com/laravel/template/demo1/build/images/flags/de.svg" class="w-20px"
                            title="de" alt="de"> <span class="ms-2"> German
                        </span></a>
                    <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            src="https://nobleui.com/laravel/template/demo1/build/images/flags/pt.svg" class="w-20px"
                            title="pt" alt="pt"> <span class="ms-2">
                            Portuguese </span></a>
                    <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            src="https://nobleui.com/laravel/template/demo1/build/images/flags/es.svg" class="w-20px"
                            title="es" alt="es"> <span class="ms-2"> Spanish
                        </span></a>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="appsDropdown">
                    ...
                    <div class="row g-0 p-1">
                        <div class="col-3 text-center">
                            <a href="https://nobleui.com/laravel/template/demo1/apps/chat"
                        ...
                        <div class="col-3 text-center">
                            <a href="https://nobleui.com/laravel/template/demo1/apps/calendar"
                                class="dropdown-item d-flex flex-column align-items-center justify-content-center w-70px h-70px"><i
                        ...
                        <div class="col-3 text-center">
                            <a href="https://nobleui.com/laravel/template/demo1/email/inbox"
                                class="dropdown-item d-flex flex-column align-items-center justify-content-center w-70px h-70px"><i
                ...
                <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
                    ...
                    <div class="p-1">
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="w-30px h-30px rounded-circle"
                                    src="https://nobleui.com/laravel/template/demo1/build/images/faces/face2.jpg"
                                    alt="userr">
                            </div>
                        ...
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="w-30px h-30px rounded-circle"
                                    src="https://nobleui.com/laravel/template/demo1/build/images/faces/face3.jpg"
                                    alt="userr">
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-4">
                        ...
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="w-30px h-30px rounded-circle"
                                    src="https://nobleui.com/laravel/template/demo1/build/images/faces/face4.jpg"
                                    alt="userr">
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-4">
                        ...
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="w-30px h-30px rounded-circle"
                                    src="https://nobleui.com/laravel/template/demo1/build/images/faces/face5.jpg"
                                    alt="userr">
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-4">
                        ...
                        <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                            <div class="me-3">
                                <img class="w-30px h-30px rounded-circle"
                                    src="https://nobleui.com/laravel/template/demo1/build/images/faces/face6.jpg"
                                    alt="userr">
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-4">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    ...
                    <img class="w-30px h-30px ms-1 rounded-circle"
                        src="https://nobleui.com/laravel/template/demo1/build/images/faces/face1.jpg" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="w-80px h-80px rounded-circle"
                                src="https://nobleui.com/laravel/template/demo1/build/images/faces/face1.jpg"
                                alt="">
                        </div>
